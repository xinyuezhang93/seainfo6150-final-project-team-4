...
export const selectProductId = ({id}) => ({type: 'SELECT_PRODUCT', payload: {
        id
    }});

export const viewProduct = ({id}) => ({type: 'VIEW_PRODUCT', payload: {
        id
    }});
...
const removeOption = (id) => ({type: 'REMOVE_OPTION', payload: {
        id
    }});

const setError = (error) => ({type: 'SET_ERROR', payload: {
        error
    }});
